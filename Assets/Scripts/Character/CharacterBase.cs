...
public abstract class CharacterBase
{
    ...
    public virtual PassiveSkillConfig Passive1Config { get; } = new(0, 0, PassiveReactivationBasis.None, 0, 1, PassiveActivationTiming.BattleStart);  // 必要であれば派生クラスでoverrideする
